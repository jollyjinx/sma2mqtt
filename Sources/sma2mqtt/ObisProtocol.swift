...
extension ObisProtocol:BinaryDecodable
{
    ...
    init(fromBinary decoder: BinaryDecoder) throws
    {
        ...
        {
            JLog.error("Could not decode ObisProtocol: at position:\(decoder.position)")
            throw ObisDecodingError.decoding("Could not decode ObisProtocol.")
        }
    }
}
